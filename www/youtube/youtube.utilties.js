(function(){
  ...
  function YouTubeUtils($log, $cordovaSocialSharing, $ionicLoading, PRIVACY, $ionicActionSheet, $filter, Popeye) {
    ...
    function swapPrivacy(status){
      ...
      newStatus.privacyStatus =  newStatus.privacyStatus === PRIVACY.PUBLIC ? PRIVACY.PRIVATE : PRIVACY.PUBLIC;
      return newStatus;
    }
    ...
    function share(playlistId){
        ...
        if(window.cordova && $cordovaSocialSharing){
          ...
          $log.info('NO $cordovaSocialSharing (...there won\'t be whilst running on your computer...)');
        }
    }
  ...
  function YoutubeModalController($scope, $log, videoId, videoParams) {
    var $ctrl = this;
    $ctrl.videoId = videoId;
    $ctrl.videoParams = videoParams;
  }
