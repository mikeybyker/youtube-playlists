(function(){
  ...
  function PlaylistsController($state, $scope, YoutubeService, $log, Utils, YouTubeUtils, authManager, authService) {
    var $ctrl = this;
    ...
    $scope.$on('$ionicView.beforeEnter', function() {
      ...
      authService.getProfileDeferred().then(function(profile) {
          ...
          // $ctrl.user = profile.name;
          getPlaylists();
        }, function(){
          // console.log('HMMM not logged in maybe...');
          $state.go('login');
        });
